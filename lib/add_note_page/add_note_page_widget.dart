...
import 'add_note_page_model.dart';
export 'add_note_page_model.dart';

class AddNotePageWidget extends StatefulWidget {
  const AddNotePageWidget({Key? key}) : super(key: key);

  @override
  _AddNotePageWidgetState createState() => _AddNotePageWidgetState();
}

class _AddNotePageWidgetState extends State<AddNotePageWidget> {
  late AddNotePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNotePageModel());
